...
public class LoreHelper {
    ...
    public static void addCurrencyLore (List<ITextComponent> tooltip, int currentCurrency, int maxCurrency) {
        tooltip.add(new StringTextComponent(TextFormatting.GRAY + "Currency: " + TextFormatting.GOLD + StringHelper.printCurrency(currentCurrency) + (maxCurrency != 0 ? (" / " + StringHelper.printCurrency(maxCurrency)) : "")));
    }
